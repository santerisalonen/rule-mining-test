/*
 ...
 currently loaded in HTML-page index.html
 TODO: do proper implementation
*/
function exportAsPNG(svg){
  var svgString = getSVGString(svg.node());
  svgString2Image( svgString, 1200, 700, 'png', save ); // passes Blob and filesize String to the callback
